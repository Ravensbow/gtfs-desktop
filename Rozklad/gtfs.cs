...
namespace gtf
{
    ...
    class Komunikacja
    {
        ...
        public ListaPrzystankow listaPrzystankow;
        public GodzinyOdjazdu godzinyOdjazdu;
       

        public Komunikacja(string miasto,ProgressBar progress)
        {
            string[] linijki;

            try
            {
                linijki = File.ReadAllLines("GTFS/" + miasto + "/agency.txt");
                ...
                linijki = File.ReadAllLines("GTFS/" + miasto + "/calendar.txt");
                ...
                if (File.Exists("GTFS/" + miasto + "/feed_info.txt"))
                {
                ...
                linijki = File.ReadAllLines("GTFS/" + miasto+ "/routes.txt");
                ...
                linijki = File.ReadAllLines("GTFS/" + miasto + "/trips.txt");
                ...
                linijki = File.ReadAllLines("GTFS/" + miasto + "/stops.txt");
                ...
                linijki = File.ReadAllLines("GTFS/" + miasto + "/stop_times.txt");
